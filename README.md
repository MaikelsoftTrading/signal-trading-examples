...
* Prices can be paired with custom data that is to be analyzed by your strategy: e.g. Twitter mentions, number of crypto wallets and other (fundamental) data.
